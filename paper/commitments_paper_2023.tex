...
\usepackage{babel}
\usepackage{babel}
\date{August 17, 2021}\usepackage{babel}
\usepackage{babel}
...
\begin{abstract}
Hyperbolic discounters value commitment contracts but may fear renegotiation between their future selves and banks. We study how the threat of renegotiation affects equilibrium contracts and bank governance. Familiar behaviors such as 'over'-borrowing or 'under'-saving can emerge, but here as strategic concessions to future selves. Banks may offer additional consumer protection through costly governance/ownership choices. By restricting their own ability to profit from renegotiation, banks can expand gains to trade and captured profits. The framework establishes new behavioral micro-foundations for a theory of commercial non-profits and helps explain historical patterns of contracting and ownership forms in consumer banking and microfinance.  
...
renegotiation cost. Competition ensures this constraint exactly
...
\begin{figure}[ht]
\includegraphics[scale=0.5]{Figure2.pdf}\caption{The no-renegotiation constraint}
...
choices are highly dependent on market structure, and nonprofit or hybrid firms may not survive in markets where banks and MFIs proliferate and contracts are non-exclusive, as experienced in many economically developing regions.
